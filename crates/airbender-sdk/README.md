...
```toml
[dependencies]
airbender = { package = "airbender-sdk", git = "https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform", branch = "main" }
```

Complete guest + host examples live in [`examples/`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples).

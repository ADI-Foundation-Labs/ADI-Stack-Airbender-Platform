...
- [`examples/fibonacci/guest`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples/fibonacci/guest) - basic no_std computation
- [`examples/u256-add/guest`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples/u256-add/guest) - no_std with external crates
- [`examples/std-btreemap/guest`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples/std-btreemap/guest) - std-enabled guest
- [`examples/cycle-markers/guest`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples/cycle-markers/guest) - profiling with delegation
- [`examples/revm-basic/guest`](https://github.com/ADI-Foundation-Labs/ADI-Stack-Airbender-Platform/tree/main/examples/revm-basic/guest) - revm transaction inside Airbender
